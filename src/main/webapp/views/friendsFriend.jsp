...
<div class="container-fluid">
    <div class="row content">
        ...
        <div id="mainContain" class="col-sm-9">
            <div class="container" style="border: none; background-color: transparent; margin: -30px 0 -10px 0;">
            ...
            <div class="well">
                <div class="btn-group btn-group-justified">
                    <a id="friends" class="btn btn-primary">Friends</a>
                    <a id="followers" href="#" class="btn btn-primary">Followers</a>
                    <a id="following" href="#following" class="btn btn-primary">Following</a>
                </div>
            </div>
            <%--<div id="searchPanel" class="well">
                    <input class="form-control" id="focusedInput" onkeyup="searchPeople()" placeholder="Search" type="text">
            </div>--%>
            <div id="rowFriendsContent" data-friend="${user.id}" class="row">
...
<script src="/resources/js/friendFriendsScript.js"></script>
