    ...
    <div class="row content">
        <div id="rowContent" class="col-sm-3 sidenav hidden-xs">
            <div id="row_content" class="col-sm-3 sidenav hidden-xs">
                <div class="logo">
                    <img data-current="${currentUser.id}" class="img-circle" src="${currentUser.avatarPath}" alt=""/>
                </div>
        ...
        <div id="mainContain" class="col-sm-9">
            <div class="well messageUpdate"><a id="messageRefresh"><span class="glyphicon glyphicon-refresh"></span></a></div>
            <div class="well messageContainer">

            </div>
            <div class="well messageSendContainer">
                <form action="">
                    <div class="input-group">
                        <textarea class="writeMessage form-control" rows="3" style="resize: none" maxlength="1000" name="message" id="writeMessage" required></textarea>
                        <div class="input-group-btn">
                            <button type="button" data-message="${dialog.id}" class="btn btn-default sendMessage" id="sendMessage"><i class="glyphicon glyphicon-send"></i></button>
                        </div>
                    </div>
                </form>
            </div>
