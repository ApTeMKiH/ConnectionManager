...
<div class="container-fluid">
    <div class="row content">
        ...
        <div id="mainContain" class="col-sm-9">
            <div class="containerImg" style="border: none; background-color: transparent; margin: -30px 0 -10px 0;">
            ...
            <div id="rowPhotoContent" class="row">
                <c:if test="${audio.size() == 0}">
                    <div id="haveNoFriend" class="col-sm-9"><div class="well">${user.name} hasn't any audio.</div></div>
                </c:if>
                <c:if test="${audio.size() != 0}">
